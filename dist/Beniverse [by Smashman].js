...
MagicItemsList.sunburst = {
    ...
    usages: 3,
    recovery: "dawn",
    action: [["reaction" /* Reaction */, " (blind)"]],
...
MagicItemsList["dragon knight helm"] = {
    ...
    source: [["Beniverse", 0]],
    type: "wondrous item" /* WondrousItem */,
    rarity: "rare" /* Rare */,
...
MagicItemsList["skybreaker"] = {
    ...
    action: [["action" /* Action */, " (summon)"], ["bonus action" /* BonusAction */, " (dismiss)"]],
    weaponOptions: [{
            regExpSearch: /skybreaker/i,
            name: "Skybreaker",
            isAlwaysProf: true,
            type: "AlwaysProf" /* AlwaysProf */,
            ability: 1 /* Strength */,
            abilitytodamage: true,
            damage: [2, 6, "force" /* Force */],
            range: "Melee",
...
SpellsList["spirit shroud-ua"] = {
    name: "Spirit Shroud",
    classes: ["cleric" /* Cleric */, "paladin" /* Paladin */, "warlock" /* Warlock */, "wizard" /* Wizard */],
    source: [["UA:SMT", 2]],
    level: 3 /* Third */,
    school: "Necro" /* Necromancy */,
    time: "1 bns" /* BonusAction */,
    range: 'Self',
    components: 'V,S',
    duration: 'Conc, 1 min',
