...
AddSubClass("fighter" /* Fighter */, "echo knight-egtw", {
    ...
    features: {
        "subclassfeature3": {
            ...
            minlevel: 3,
            description: desc([]),
            action: [["bonus action" /* BonusAction */, " (summon)"], ["bonus action" /* BonusAction */, " (swap)"]],
            eval: function () {
                companionUtil.add("Echo");
            },
            removeeval: function () {
                companionUtil.remove("echo");
                if (CreatureList.echo && CreatureList.echo.removeeval)
                    CreatureList.echo.removeeval();
            }
        },
        "subclassfeature3.1": {
...
AddSubClass("wizard" /* Wizard */, "chronurgy magic-egtw", {
...
AddSubClass("wizard" /* Wizard */, "graviturgy magic-egtw", {
