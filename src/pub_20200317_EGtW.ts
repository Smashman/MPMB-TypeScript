...
AddSubClass(CharacterClass.Fighter, "echo knight-egtw", {
	...
	features : {
		"subclassfeature3" : {
			...
			action: [[ActionType.BonusAction, " (summon)"], [ActionType.BonusAction, " (swap)"]],
			eval : function () {
...
AddSubClass(CharacterClass.Wizard, "chronurgy magic-egtw", {
...
AddSubClass(CharacterClass.Wizard, "graviturgy magic-egtw", {
...
RaceList["draconblood"] = {
	...
	weaponOptions : [{
		...
		source : [["SRD", 5], ["P", 34]],
		ability : 3,
		type : WeaponType.Natural,
		damage : [2, 6, DamageType.Fire],
		range : "15-ft cone",
...
RaceList["sea elf"] = {
	...
	skills : [SkillProficiency.Perception],
